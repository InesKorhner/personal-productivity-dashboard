...
export function HabitItem({
  ...
  return (
    <li className="border-border bg-card flex max-w-[700px] flex-col gap-2 rounded-lg border px-2 py-1 text-sm sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex w-full flex-wrap items-center justify-start gap-1 sm:w-auto sm:justify-start sm:space-x-2">
